// mobile/src/components/ImageGallery.tsx
import { useState, } from "react";
import { FlatList, View, Image, StyleSheet } from "react-native";
import { borderRadius, colors, palette, spacing } from "../styles";

export default function ImageGallery({ images, width, height }: any) {
    ...
    return (
        <View style={{ width: width, height: height }}>
            <FlatList
                ...
                renderItem={({ item }) => (
                    <Image source={{ uri: item }} style={[styles.image, { width: width, height: height }]} />
                )}
            />
            {images.length > 1 && (
